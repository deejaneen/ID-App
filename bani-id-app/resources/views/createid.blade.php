    ...
    <div class="create-id-main-container">
        ...
        <main>
            <div class="create-id-container">
                ...
                <div class="card-container" id="createCard">
                    <div class="button-section">
                        <button class="btn-create btn btn-primary btn-lg rounded-pill toogle-btn"  id="createTogglebtn" data-mdb-ripple-init>
                        ...
                        <div class="dcs-department">
                            ...
                            <div class="dropdown-center department">
                                ...
                                <ul class="dropdown-menu" style="min-width: 100%;">
                                    ...
                                    <li><a class="dropdown-item" href="javascript:void(0);" data-value="Non - COA">Test2</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="card-container" id="editCard" style="display: none;">
                    <div class="button-section">
                        <button class="btn-edit btn btn-primary btn-lg rounded-pill toogle-btn"   id="editTogglebtn" data-mdb-ripple-init>
                            Edit
                        </button>
                        {{-- <button class="btn-edit btn btn-primary btn-lg rounded-pill">
                            Edit
                    ...
                    <table class="table-home table-hover" id="EditIDTable" style="width: 100%">
                        <thead>
                            <tr>
